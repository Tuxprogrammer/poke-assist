 ...
 *
 * @description Ruby, Sapphire, Emerald, Colosseum, XD: Gale of Darkness - Hoenn Region & Orre Region
 * @generation 3
 * @region Hoenn/Orre
 * @idRange 252-386
 * @features
 *   - Introduced abilities system
 *   - Weather-based mechanics and double battles
...
export const pokemonRSE: Pokemon[] = [
  ...
  { id: 146.2, name: 'moltres-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 243.2, name: 'raikou-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 244.2, name: 'entei-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 245.2, name: 'suicune-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 249.2, name: 'lugia-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 250.2, name: 'ho-oh-shadow', types: ['shadow'], form: 'Shadow' },
  ...
  { id: 261.2, name: 'poochyena-shadow', types: ['shadow'], form: 'Shadow' },
  ...
  { id: 273.2, name: 'seedot-shadow', types: ['shadow'], form: 'Shadow' },
  ...
  { id: 280.2, name: 'ralts-shadow', types: ['shadow'], form: 'Shadow' },
  {
    id: 281,
    name: 'kirlia',
    types: ['psychic', 'fairy'],
  ...
  { id: 285.2, name: 'shroomish-shadow', types: ['shadow'], form: 'Shadow' },
  ...
  { id: 296.2, name: 'makuhita-shadow', types: ['shadow'], form: 'Shadow' },
  ...
  { id: 301.2, name: 'delcatty-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 302, name: 'sableye', types: ['dark', 'ghost'] },
  { id: 302.2, name: 'sableye-shadow', types: ['shadow'], form: 'Shadow' },
  {
    id: 303,
    name: 'mawile',
    types: ['steel', 'fairy'],
  ...
  { id: 315.2, name: 'roselia-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 316, name: 'gulpin', types: ['poison'] },
  { id: 316.2, name: 'gulpin-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 317, name: 'swalot', types: ['poison'] },
  { id: 318, name: 'carvanha', types: ['water', 'dark'] },
  { id: 318.2, name: 'carvanha-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 319, name: 'sharpedo', types: ['water', 'dark'] },
  { id: 319.2, name: 'sharpedo-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 320, name: 'wailmer', types: ['water'] },
  { id: 321, name: 'wailord', types: ['water'] },
  { id: 322, name: 'numel', types: ['fire', 'ground'] },
  { id: 322.2, name: 'numel-shadow', types: ['shadow'], form: 'Shadow' },
  ...
  { id: 329.2, name: 'vibrava-shadow', types: ['shadow'], form: 'Shadow' },
  ...
  { id: 337.2, name: 'lunatone-shadow', types: ['shadow'], form: 'Shadow' },
  ...
  { id: 343.2, name: 'baltoy-shadow', types: ['shadow'], form: 'Shadow' },
  ...
  { id: 355.2, name: 'duskull-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 356, name: 'dusclops', types: ['ghost'] },
  { id: 357, name: 'tropius', types: ['grass', 'flying'] },
  { id: 357.2, name: 'tropius-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 358, name: 'chimecho', types: ['psychic'] },
  { id: 359, name: 'absol', types: ['dark'] },
  { id: 359.2, name: 'absol-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 360, name: 'wynaut', types: ['psychic'] },
  { id: 361, name: 'snorunt', types: ['ice'] },
  { id: 361.2, name: 'snorunt-shadow', types: ['shadow'], form: 'Shadow' },
  { id: 362, name: 'glalie', types: ['ice'] },
  { id: 363, name: 'spheal', types: ['ice', 'water'] },
  { id: 363.2, name: 'spheal-shadow', types: ['shadow'], form: 'Shadow' },
