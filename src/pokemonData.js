...
// Complete Pokémon database with generation-specific types and all forms
// Structure: { id, name, types, generationTypes?, form?, region? }
export const pokemonList = [
  ...
  { id: 172, name: 'pichu', types: ['electric'] },
  {
    ...
    name: 'cleffa',
    types: ['fairy'],
    generationTypes: { 2: ['normal'], 6: ['fairy'] },
  },
  {
    id: 174,
    name: 'igglybuff',
    types: ['normal', 'fairy'],
    generationTypes: { 2: ['normal'], 6: ['normal', 'fairy'] },
  },
  {
    id: 175,
    name: 'togepi',
  ...
  },
  {
    ...
    name: 'togetic',
    types: ['fairy', 'flying'],
    generationTypes: { 2: ['normal', 'flying'], 6: ['fairy', 'flying'] },
  },
  ...
  { id: 182, name: 'bellossom', types: ['grass'] },
  {
    ...
    name: 'marill',
    types: ['water', 'fairy'],
    generationTypes: { 2: ['water'], 6: ['water', 'fairy'] },
  },
  {
    id: 184,
    name: 'azumarill',
  ...
  // Generation 3 (252-386) - Key Pokémon
  ...
  // Generation 4 (387-493) - Sinnoh Region
  ...
  { id: 438, name: 'bonsly', types: ['rock'] },
  {
    ...
    name: 'mimejr',
    types: ['psychic', 'fairy'],
    generationTypes: { 4: ['psychic'], 6: ['psychic', 'fairy'] },
  },
  ...
  { id: 467, name: 'magmortar', types: ['fire'] },
  {
    ...
    name: 'togekiss',
    types: ['fairy', 'flying'],
    generationTypes: { 4: ['normal', 'flying'], 6: ['fairy', 'flying'] },
  },
  ...
  // Generation 5 (494-649) - Unova Region
  ...
  { id: 545, name: 'scolipede', types: ['bug', 'poison'] },
  {
    ...
    name: 'cottonee',
    types: ['grass', 'fairy'],
    generationTypes: { 5: ['grass'], 6: ['grass', 'fairy'] },
  },
  {
    id: 547,
    name: 'whimsicott',
  ...
  // Generation 6 (650-721) - Kalos Region and Fairy Type Introduction
  ...
  // Generation 7 (722-809) - Alola Region
  ...
  { id: 745.1, name: 'lycanroc-midday', types: ['rock'], form: 'Midday Form' },
  {
    id: 745.2,
  ...
  { id: 745.3, name: 'lycanroc-dusk', types: ['rock'], form: 'Dusk Form' },
  ...
  // Generation 8 (810-898) - Galar Region
  ...
  // Generation 9 (906-1010) - Paldea Region
  ...
  { id: 964.1, name: 'palafin-hero', types: ['water'], form: 'Hero Form' },
  ...
  { id: 986, name: 'brute-bonnet', types: ['grass', 'dark'], form: 'Paradox' },
  { id: 987, name: 'flutter-mane', types: ['ghost', 'fairy'], form: 'Paradox' },
  {
    id: 988,
    name: 'slither-wing',
    types: ['bug', 'fighting'],
  ...
  { id: 990, name: 'iron-treads', types: ['ground', 'steel'], form: 'Paradox' },
  { id: 991, name: 'iron-bundle', types: ['ice', 'water'], form: 'Paradox' },
  {
    id: 992,
    name: 'iron-hands',
  ...
  { id: 993, name: 'iron-jugulis', types: ['dark', 'flying'], form: 'Paradox' },
  { id: 994, name: 'iron-moth', types: ['fire', 'poison'], form: 'Paradox' },
  {
    id: 995,
    name: 'iron-thorns',
    types: ['rock', 'electric'],
...
export function getPokemonTypes(pokemon, generation = 9) {
  ...
  if (pokemon.generationTypes) {
    ...
    if (availableGenerations.length > 0) {
      return pokemon.generationTypes[availableGenerations[0]];
    }
  }
...
export function getTypeEffectiveness(
  ...
  for (const defType of defendingTypes) {
    const matchup = currentTypeChart[attackingType]?.[defType] ?? 1;
...
function getTypesForGeneration(generation) {
  const baseTypes = [
    'normal',
    'fire',
    'water',
...
export function categorizeEffectiveness(defendingTypes, generation = 9) {
  const categories = {
    noEffect: [],
    notVeryEffective: [],
    normal: [],
