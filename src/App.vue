...
import { typeColors, categorizeEffectiveness, getPokemonTypes, getPokemonDisplayName, type Pokemon, type PokemonType, type Generation, type EffectivenessCategories } from './pokemonData';
